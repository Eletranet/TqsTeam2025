...
export default function CustomModal({ open, onClose, title, description, children }: CustomModalProps) {
  return (
    <Modal
      open={open}
      onClose={onClose}
    ...
    >
      <ModalContent sx={{ width: 650,height:"60%" ,marginTop:"-8%",backgroundColor:"#222",borderColor:"#222",borderRadius:"30px"}}>
           <img 
...
// ... (Mantém o resto do código como está: Backdrop, StyledBackdrop, Modal, ModalContent, cores, etc.)
